...
export default function Home() {
  ...
  return (
    ...
    <main>
      ...
      <h1>Aqui na Krystal Festas seus sonhos brilham!</h1>
        ...
        <button class="home-button">AGENDAR UMA VISITA</button>
      </section>
  ...
  <tr>
    <td>Sim, Brigadeiros Beijinhos Cajuzinhos</td>
  </tr>
  <tr>
    <td>Sim</td>
  </tr>
  ...
  <tr>
    <td>SimChurrasqueiro ou Fritadeira</td>
  </tr>
  <tr>
    <td>Não</td>
  </tr>
      ...
      <div className='bo'>
        ...
        <Carousel
                images={[
                  <Image width={500} height={500} src="https://static.wixstatic.com/media/59faf3_cab1dcd4ecaf4a6b85897d0df15d0631~mv2.jpg/v1/fill/w_960,h_540,al_c,q_85,enc_auto/59faf3_cab1dcd4ecaf4a6b85897d0df15d0631~mv2.jpg" />,
